		...
		<div id="pL"><!--Połączenie z bazą-->
			...
			<?php
				...
				if(isset($_POST['dodaj'])){
					...
					//if($row['nazwa_produktu']=$nazwa_produktu AND $row['typ']=$typ AND $row['sklep']=$sklep){
				...
				if(isset($_POST['edytuj'])){
					...
					if($ID_produktu=$wybrany_produkt['ID_produktu']){//wyświetlanie panelu edycji
						...
						<form method=POST action=index.php>
							...
							<table>
							<tr>	<td class=lewetd>ID produktu:</td><td class=prawetd><input type=text name=ID_produktu_edytuj value=".$wybrany_produkt['ID_produktu']."> </td>	</tr>
						...
						if(isset($_POST['edytuj_zatwierdz'])){//wyświetlanie panelu edycji
							$ID_produktu=$_POST["ID_produktu_edytuj"];
